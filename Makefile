...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/home/machinelearning/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/home/machinelearning/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/home/machinelearning/$(BIND_DIR)")
...
UBUNTU_IMAGE := opencv-machinelearning-java-dev:01
